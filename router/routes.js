...
const { createemployee, getAllUser, getSingleUser, update, deleteUser } = require("../controller/employeeController");
const router  =express.Router() ;
const companytable = require("../models").company;

// api for creating new user details  
...
// api for deleting user from database 
